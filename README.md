...
Cards are generated by [GitHub Actions](.github/workflows/grs.yml) (no dependency on the public Vercel instance). After the first push, run the workflow once in the **Actions** tab to generate the SVGs.
